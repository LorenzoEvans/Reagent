(defproject blog-app "0.1.0-SNAPSHOT"
  ...
  :ring {:handler blog-app.handler/app
         :uberwar-name "blog-app.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "blog-app.jar"
  :main blog-app.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "blog-app.core/mount-root"}
             :compiler
             {:main "blog-app.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns blog-app.repl}
